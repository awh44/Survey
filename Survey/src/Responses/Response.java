...
abstract public class Response implements Serializable
{
	...
	//following two methods automatically generated by Eclipse
	//to follow Java's language standards. Make it easy to compare
	//two responses for equality and to use them as keys in Maps
	//(for tabulating). Only choices_ matters in the actual comparison
	//for equality.
	@Override
	public int hashCode()
	{
